...
{
    use HasFactory;
    protected $fillable = ['lang_code', 'name', 'base_language_id', 'country_id', 'status', 'is_active_translation', 'is_valid_language_code', 'faq_slug', 'alternatives_slug', 'reviews_slug', 'comparisons_slug'];
