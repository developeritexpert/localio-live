...
@section('content')
<div class="nk-block nk-block-lg all-vendors">
                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            <li class="nk-block-tools-opt">
                                <a href="{{ route('admin-add-vendors') }}" class="btn btn-icon btn-primary d-md-none">
                                    <em class="icon ni ni-plus"></em>
                                </a>
                                <a href="{{ route('admin-add-vendors') }}" class="btn btn-primary d-none d-md-inline-flex">
                                ...
                                <li>
                                    <div class="drodown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end edit-btn"
                                            ...
                                            @endif
                                                <li>
                                                    <a href="{{ route('admin-edit-vendors',['id'=>$user->id]) }}">
                                                        <em class="icon ni ni-edit-fill"></em></em>Edit
                                                    </a>
                                                </li>
                                                <li class="removeConfermation"
                                                data-url="{{ route('admin-delete-vendors', $user->id) }}">
                                                    <a href='{{ route('admin-delete-vendors', $user->id)}}' >
...
<div class="text-center">
    <button class="btn btn-primary btn-localio">No Vendor found</button>
</div>
@endif
