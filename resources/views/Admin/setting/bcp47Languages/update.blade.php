    ...
    <div class="nk-block nk-block-lg">
        <div class="nk-block-head d-flex justify-content-between">
            <div class="nk-block-head-content">
                <h4 class="title nk-block-title">Edit BCP 47 Language</h4>
                <div class="nk-block-des text-soft">
                    <p>Update the BCP 47 code details.</p>
                </div>
            </div>
            <div class="nk-block-head-content">
        ...
        <div class="card card-bordered">
            <div class="card-inner">
                <form action="{{ route('bcp47-languages.updateProcc', $bcp47Language->id) }}" class="form-validate" method="post">
                    @csrf
                    <div class="row g-gs">
                        <!-- BCP 47 Code -->
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="code" name="code"
                                        value="{{ old('code', $bcp47Language->code) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ old('name', $bcp47Language->name) }}"
                                ...
                                <div class="form-control-wrap d-flex align-items-center gap-2">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="status" name="status"
                                            value="1" {{ old('status', $bcp47Language->status) == 1 ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="status"></label>
                                    </div>
                                    <span id="statusText" style="font-weight: 600;">
                                        {{ old('status', $bcp47Language->status) == 1 ? 'Active' : 'Inactive' }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn-lg btn-primary btn-localio">Update BCP 47 Language</button>
                            </div>
                        </div>
                    </div>
                </form>
