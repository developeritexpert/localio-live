<div class="nk-block nk-block-lg">
    ...
    @if ($editMode)
        <form wire:submit.prevent="{{ $businessId ? 'updateBusiness' : 'storeBusiness' }}" method="POST"
            ...
            @csrf
            <div x-show="!isAffiliate" x-cloak class="alert alert-warning py-2 px-3 mb-3 d-flex align-items-center" role="alert" style="font-size: 0.875rem; border-left: 4px solid #ffc107; background-color: #fffbeb; @if($is_affiliate) display: none !important; @endif">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div class="form-check form-switch m-0">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            x-model="isAffiliate" id="affiliateToggleFormMain" style="cursor: pointer; width: 2.75rem; height: 1.35rem;">
                                    </div>
                                </div>
                                <div>
                                ...
                                <div x-show="isAffiliate" class="border rounded-2 p-3 mb-3" style="background-color: #f8f9fa;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="form-check form-switch d-flex align-items-center m-0">
                                            <input class="form-check-input" type="checkbox" id="countryAffiliateToggleForm"
                                                wire:model="countryIsAffiliate" style="width: 2.5rem; height: 1.25rem; cursor: pointer;">
                                            <label class="form-check-label ms-2 mb-0" for="countryAffiliateToggleForm">
                                                            ...
                                                            @else
                                                                ...
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-md-4 d-flex justify-content-end gap-1">
                                                                        <button type="button" class="btn btn-outline-light btn-icon btn-sm text-primary"
                                                                            wire:click="editUrl({{ $countryId }}, {{ $index }})"
                                                                            title="Edit URL">
                                                                            <em class="icon ni ni-edit"></em>
                                                                        </button>
                                                                        <button type="button" class="btn btn-outline-light btn-icon btn-sm text-danger"
                                                                            wire:loading.attr="disabled"
