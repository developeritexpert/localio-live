...
@section('meta_title', format_meta_text('Terms of Service | Localio'))
@section('content')
    ...
    <section class="pvc_sec py-5" id="pvc_section">
        <div class="container">
            <div class="row">
                <!-- Left Sidebar -->
                <div class="col-md-4">
                    @include('User.terms_condition._sidebar', ['activeSlug' => 'terms-of-service'])
                </div>
                ...
                <div class="col-md-8">
                    @if (isset($document))
                        <div class="mb-5">
                            <h2 class="mb-4">{{ $document->title ?? 'Terms of service' }}</h2>
                            <div>{!! $document->description ?? '' !!}</div>
                        </div>
                    @elseif (isset($terms) && $terms->isNotEmpty())
