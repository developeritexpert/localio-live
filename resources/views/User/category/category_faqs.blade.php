        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8 col-12">
                                        ...
                                        <div class="faq-feedback-row">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div class="faq-feedback-actions">
                                                    <button type="button" class="btn-vote-faq" onclick="voteCategoryFaq({{ $index }}, true, this)">
                                                        👍 Yes
                                                    </button>
                                                    <button type="button" class="btn-vote-faq" onclick="voteCategoryFaq({{ $index }}, false, this)">
                                                        👎 No
                                                    </button>
                                                </div>
                                            </div>
                ...
                <div class="ask-community-banner">
                    ...
                    <div>
                        <a href="{{ route('category.detail', ['locale' => app()->getLocale(), 'slug' => $catSlug]) }}" class="ask-community-btn">
                            Explore {{ strtolower($catName) }} <i class="fa-solid fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
...
<script>
    ...
    function voteCategoryFaq(faqIndex, isHelpful, button) {
