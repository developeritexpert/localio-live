...
<head>
    ...
    @media (max-width: 991px) {
        ...
        .sli_img {
            ...
            /* Vertically center logo with title block */
        }
        ...
        .tp-btm {
            ...
            /* tight 6px top spacing directly below title */
            padding: 0 !important;
        }
        ...
        .sl_main h6 {
            ...
            /* Clear old absolute padding offset */
            font-size: 16px !important;
            line-height: 1.3 !important;
            margin: 0 !important;
        }
        ...
        .reviews_block .inn_sl_hed {
            ...
            /* Specific bottom margin for reviews */
        }
        ...
        .automotive-card .sl_main {
            ...
            /* Space on the right for absolute wishlist badge */
            position: relative !important;
        }
        ...
        .automotive-card .auto-choice-hd .tp-btm.flex-col-mob {
            ...
            /* tight 4px spacing directly below title */
            padding: 0 !important;
        }
    ...
    .see-all-category-container {
        ...
        /* Matches line-height height of h2 popular-categories-title */
        margin-top: 0 !important;
        margin-bottom: 24px !important;
        display: flex !important;
        align-items: center !important;
...
<body class="@yield('body_class')">
    ...
    <div class="transparency-banner">
        <div class="inr-trans">
            <div
                style=" font-size: 10px; color: #e5e4e4; line-height: 1; font-family: sans-serif; max-height: 22px; overflow: hidden; vertical-align: middle;">
                {{ static_text('localio_commissions_message')}}
                <a href="#" onclick="event.preventDefault(); openModal()"
                    style="color: #e5e4e4;  text-decoration:none; transition: color 0.2s;">Learn more</a>
            </div>
        </div>
        ...
        <section class="sec_head">
            <div class="bottom_header dark">
                <div class="container-fluid">
                    ...
                    <a href="javascript:void(0);" onclick="openLoginModal()" class="cta cta_orange wht-t-org-btn">
                        {{ $headerContent['sign_up_btn_lable'] ?? 'Sign Up' }}
                    </a>
                    @else
                    <x-user-profile />
                    ...
                    <nav id="mobile_res" class="navbar navbar-expand-lg">
                            ...
                            <div class="left_menu">
                                <ul class="menu">
                                    <li class="menu-item cat_menu_item">
                                        <a href="javascript:void(0);" id="open-categories-sidebar"><i
                                                class="fa-solid fa-bars me-2"></i>{{ $headerContent['Categories'] ?? 'All' }}</a>
                                    </li>
                                    <li class=" menu-item cat_menu_item">
                                        <a
                        ...
                        <div id="phone_screen" class="mobile_display">
                            ...
                            <div class="user_img drop_menu">
                                <div class="usr_profile">
                                    ...
                                    <img src="{{ asset(Auth::user()->profile_image) }}" class="img-fluid profile-circle"
                                        style='border-radius: 50%; width: 40px; height: 40px; object-fit: cover; flex-shrink: 0;'>
                                    @else
                                    <div class="profile-circle"
                                        style="width: 40px; height: 40px; min-width: 40px; min-height: 40px; border-radius: 50%; background-color: #f76b1c; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                        <span
                                            style="color: white; font-weight: bold; font-size: 18px; line-height: 1; margin-top: 2px;">
                                    ...
                                    <div class="dropdown-main">
                                        <div class="user_detail">
                                            <div class="user_img">
                                                ...
                                                <img src="{{ asset(Auth::user()->profile_image) }}"
                                                    ...
                                                    style='border-radius: 50%; width: 50px; height: 50px; object-fit: cover; flex-shrink: 0;'>
                                                @else
                                                <div class="profile-circle"
                                                    style="width: 50px; height: 50px; min-width: 50px; min-height: 50px; border-radius: 50%; background-color: #002347; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                                    <span
                                                        style="color: white; font-weight: bold; font-size: 20px; line-height: 1; margin-top: 2px;">
                                                        {{ strtoupper(substr(Auth::user()->first_name ?? 'A', 0, 1)) }}
                                                    </span>
                                                </div>
                                                @endif
                                        ...
                                        <div class="dash-icon">
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('user-dashboard', ['locale' => app()->getLocale()]) }}">
                                                <i class="fa-solid fa-envelope-open-text"></i>Dashboard
                                            </a>
                                            @elseif(Auth::user()->user_type === 'vendor')
                                            <a class="dropdown-item"
                                                href="{{ route('vendor-overview', ['locale' => app()->getLocale()]) }}">
                                                <i class="fa-solid fa-envelope-open-text"></i>Dashboard
                                            </a>
                                            @endif
                                        </div>
                                        ...
                                        <div class="dash-icon">
                                            @if(Auth::user()->user_type === 'user')
                                            <a class="dropdown-item"
                                                href="{{ route('user-profile', ['locale' => app()->getLocale()]) }}">
                                                <i class="fa fa-user"></i>My discussions
                                            </a>
                                            @elseif(Auth::user()->user_type === 'vendor')
                                            <a class="dropdown-item"
                                                href="{{ route('vendor-profile', ['locale' => app()->getLocale()]) }}">
                                        ...
                                        <div class="dash-icon">
                                            @if(Auth::user()->user_type === 'user')
                                            <a class="dropdown-item"
                                                href="{{ route('user-change-password', ['locale' => app()->getLocale()]) }}">
                                        ...
                                        <div class="dash-icon">
                                            @if(Auth::user()->user_type === 'user')
                                            <a class="dropdown-item"
                                                href="{{ route('user-email-preferences', ['locale' => app()->getLocale()]) }}">
                                                <i class="fa-solid fa-envelope"></i>Email preferences
                                            </a>
                                            @elseif(Auth::user()->user_type === 'vendor')
                                            <a class="dropdown-item"
                                                href="{{ route('vendor-configuration', ['locale' => app()->getLocale()]) }}">
                            ...
                            <div class="msp_panel" id="mspPanel">
                                ...
                                <div class="msp_panel_header">
                                    <div class="msp_logo_col">
                                        ...
                                        <a href="{{ route('home', ['locale' => app()->getLocale()]) }}"
                                            class="msp_brand">
                                            <img src="{{ asset($headerLogo->meta_value) }}"
                                                alt="{{ $headerLogo->meta_key }}">
                                        </a>
                                        @else
                                        <a href="{{ route('home', ['locale' => app()->getLocale()]) }}"
                                            class="msp_brand">
                                    ...
                                    <button type="button" class="msp_close_btn" onclick="msp_closePanel()"
                                        aria-label="Close">
                                ...
                                <div class="msp_panel_body">
                                    ...
                                    <div class="msp_intro">
                                        ...
                                        <p class="msp_subtitle">Create an Account and Secure Your Exclusive Logo Today.
                                        </p>

                                        <div class="msp_buttons">
                                            <a href="{{ route('write-review', ['locale' => app()->getLocale()]) }}"
                                                class="msp_btn msp_btn_outline">Write a review</a>
                                            <a href="javascript:void(0);" onclick="openLoginModal()"
                                                class="cta cta_orange wht-t-org-btn">
                                                Sign in
                                            </a>
                                    ...
                                    <div class="msp_links_section">
                                        ...
                                        <ul class="msp_link_list">
                                            <li><a
                                                    href="{{ route('who-we-are', ['locale' => session('lang_code', 'en-us')]) }}">Who
                                                    we are</a></li>
                                            <li><a
                                                    href="{{ route('privacy-policy', ['locale' => session('lang_code', 'en-us')]) }}">Privacy
                                                    policy</a></li>
                                            <li><a
                                                    href="{{ route('terms-condition', ['locale' => session('lang_code', 'en-us')]) }}">Terms
                                                    & conditions</a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="msp_links_section">
                                        ...
                                        <ul class="msp_link_list">
                                            <li><a
                                                    href="{{ route('contact', ['locale' => session('lang_code', 'en-us')]) }}">Contact</a>
                                            </li>
                                            <li><a
                                                    href="{{ route('FaqsShow', ['locale' => session('lang_code', 'en-us')]) }}">FAQs</a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        @media (max-width: 991px) {
                            ...
                            .mobile-cat-panel {
                                ...
                                background: #002347;
                                z-index: 100002;
                                /* higher than .mobile-sidebar so it sits above it */
                        ...
                        <div class="mobile-sidebar">
                            ...
                            <div class="mobile-sidebar-body">
                                ...
                                <div class="menu_section">
                                    <a href="javascript:void(0);" id="open-mobile-cat-panel"
                                        class="section_heading_link">
                                    ...
                                    <ul class="flat_list">
                                        <li>
                                            <a
                                                href="{{ route('top-rated-product', ['locale' => session('lang_code', 'en-us')]) }}">
                            ...
                            <div class="mobile-cat-panel-body">
                                <ul class="mobile-cat-list">
                                    ...
                                    <li class="mobile-cat-item">
                                        <a href="javascript:void(0);" class="mobile-cat-toggle"
                                            data-target="mobile-cat-sub-{{ $cat->id }}">
                                ...
                                toggle.addEventListener('click', function() {
                                    ...
                                    toggles.forEach(function(t) {
                                        if (t !== toggle) {
                                            ...
                                            const otherSublist = document
                                                .getElementById(t.getAttribute(
                                                    'data-target'));
                                            if (otherSublist) otherSublist.style
                                                .maxHeight = null;
                                        }
                                    });
                        ...
                        <div class="foot-row-lft p_80">
                            ...
                            <div class="foot-col footer-dropdown">
                                ...
                                <ul class="foot-col-list">
                                    ...
                                    <li>
                                        <a
                                            href="{{ route('write-review', ['locale' => session('lang_code', 'en-us')]) }}">Write
                                            review</a>
                                    </li>
                                    {{-- <li><a
                            ...
                            <div class="foot-col footer-dropdown">
                                ...
                                <ul class="foot-col-list">
                                    ...
                                    <li><a
                                            href="{{ route('privacy-policy', ['locale' => session('lang_code', 'en-us')]) }}">{{ $footerContents['privacy_policy'] ?? 'Privacy policy' }}</a>
                                    </li>
                                    <li><a
                                            href="{{ route('cookie-policy', ['locale' => session('lang_code', 'en-us')]) }}">{{ $footerContents['cookie_policy'] ?? 'Cookie policy' }}</a>
                                    </li>
                                    <li><a
                                            href="{{ route('community-guidelines', ['locale' => session('lang_code', 'en-us')]) }}">{{ $footerContents['community_guidelines'] ?? 'Community guidelines' }}</a>
                                    </li>
                                    <li><a
                                            href="{{ route('affiliate-disclosure', ['locale' => session('lang_code', 'en-us')]) }}">{{ $footerContents['affiliate_disclosure'] ?? 'Affiliate disclosure' }}</a>
                                    </li>
                                    <li><a
                                            href="{{ route('copyright-dmca-policy', ['locale' => session('lang_code', 'en-us')]) }}">{{ $footerContents['copyright_dmca_policy'] ?? 'Copyright & DMCA policy' }}</a>
                                    </li>
                                    <li><a
                                            href="{{ route('legal-notice', ['locale' => session('lang_code', 'en-us')]) }}">{{ $footerContents['legal_notice'] ?? 'Legal notice' }}</a>
                                    </li>
                                </ul>
                            </div>
                            {{-- <div class="foot-col">
                            ...
                            <ul class="foot-col-list">
                                ...
                                <li>
                                    <a
                                        href="{{ route('vendor-how-it-work', ['locale' => session('lang_code', 'en-us')]) }}">
                                        How It Works</a>
                                </li>
                                <li>
                            ...
                            <li>
                                <a href="{{ $footerMediaUrls['facebook_url'] ?? '#' }}" target="_blank">
                                    ...
                                    <img class="media_icon" src="{{ asset($facebookIcon->meta_value) }}"
                                        ...
                                        style="width: 30px; height: 30px; filter: brightness(0) invert(1);">
                                    @else
                                    <i class="fa-brands fa-facebook-f" style="color: #ffffff; font-size: 30px;"></i>
                                    @endif
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ $footerMediaUrls['twitter_url'] ?? '#' }}" target="_blank">
                                    ...
                                    <img class="media_icon" src="{{ asset($twitterIcon->meta_value) }}"
                                        ...
                                        style="width: 30px; height: 30px; filter: brightness(0) invert(1);">
                                    @else
                                    <i class="fa-brands fa-twitter" style="color: #ffffff; font-size: 30px;"></i>
                                    @endif
                                </a>
                            </li>
                        </ul>
        ...
        <div class="circle_11">
            ...
            <div class="modal-content">
                ...
                <div class="modal-disclaimer mt-0">
                    <strong>Disclosure:</strong> We may earn a commission from some links. Commercial relationships do
    ...
    <div id="login-modal"
        ...
        role="dialog" aria-labelledby="modal-title" aria-hidden="true" style="display: none;">
        ...
        <div class="modal-content bg-white rounded-2xl relative" style="width: 380px; padding: 48px 40px 40px 40px;">
            ...
            <div class="text-center">
                ...
                <p class="text-center" style="margin-bottom: 20px;">Continue with Google or use your email and password.
                </p>
                            ...
                            <div class="contact_content" data-aos="fade-up" data-aos-duration="1000">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-12">
                                            <div class="login_box size18" style="text-align: center;">
                                                <div class="l_goin1">
                                                    <a href="{{ route('google.login') }}" class="login_link"
                                                        onclick="openGoogleLogin(event)"
                                                        style="background: #DB4437; display: flex; align-items: center; justify-content: center; width: 100%; border-radius: 4px; padding: 12px; color: #fff; text-decoration: none; font-weight: 500;">
                                                        <span class="scl-icn"
                                ...
                                <form class="login_form" action="{{ route('login_process') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        <x-google-input type="text" name="email" id="emailAddress" label="Email"
                                            :attributes="['autocomplete' => 'off']" />
                                    </div>
                                    <div class="form-group">
                                        {{-- <input type="password" class="form-control" id="password" name="password" placeholder="Password"> --}}
                                        <x-google-input type="password" name="password" id="password" label="Password"
                                            :attributes="['autocomplete' => 'off']" />
                                    ...
                                    <div class="form-row align-items-center">
                                        <div class="col frgt_btn text-right">
                                            <a href="{{ route('recover-password') }}" class="small"
                                                onmouseover="this.style.color='#f9633b'"
                                                onmouseout="this.style.color='#06498b'"
                                                style="margin-top: -6px;">{{ static_text('forgot_password') }}</a>
                                        </div>
                                    </div>
                                    <div class="accor-btn">
    ...
    @endphp
    <div id="register-profile-modal"
        class="modal-overlay fixed inset-0 z-[9999] align-items-center justify-content-center p-3"
        style="background: rgba(0, 0, 0, 0.5); position: fixed; top: 0; left: 0; right: 0; bottom: 0; overflow-y: auto; display: flex;">
        <div class="modal-content bg-white shadow-lg relative border-0 my-auto"
            style="max-width: 620px; width: 100%; padding: 40px 36px 36px 36px; border-radius: 16px !important; background: #ffffff; position: relative;">
            ...
            <div class="text-center mb-4">
                ...
                <p class="text-muted m-0" style="font-size: 13.5px;">Please provide a few more details to set up your
                    account.</p>
            </div>

            <form class="register_form" action="{{ route('register.details.store', ['locale'=> getCurrentLocale()]) }}"
                method="post" id="modalRegisterDetailsForm">
                @csrf
                <div class="row g-2 mb-3">
                    <div class="col-6">
                        <div class="form-floating">
                            <input type="text" name="first_name" id="modalFirstName" class="form-control"
                                placeholder="First name" value="{{ old('first_name', $pendingFirstName) }}" required>
                            <label for="modalFirstName">First name</label>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-floating">
                            <input type="text" name="last_name" id="modalLastName" class="form-control"
                                placeholder="Last name" value="{{ old('last_name', $pendingLastName) }}" required>
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="job_title" id="modalJobTitle" class="form-control" placeholder="Job title"
                ...
                <div class="form-floating mb-3">
                    <select name="company_size" id="modalCompanySize" class="form-select" required>
                        ...
                        <option value="2" {{ old('company_size') == '2' ? 'selected' : '' }}>Small Business (1-50 emp.)
                        </option>
                        <option value="3" {{ old('company_size') == '3' ? 'selected' : '' }}>Mid-Market (51-1000 emp.)
                        </option>
                        <option value="4" {{ old('company_size') == '4' ? 'selected' : '' }}>Enterprise (&gt;1000 emp.)
                        </option>
                    </select>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="form-check ">
                            <input class="form-check-input" type="checkbox" name="accept_terms" id="acceptTerms"
                                value="1" {{ old('accept_terms') ? 'checked' : '' }} required>

                            <label class="form-check-label" for="acceptTerms">
                                I agree to the
                                <a href="{{ route('terms-condition', ['locale' => getCurrentLocale()]) }}"
                                    target="_blank" class="policy-link">
                                    Terms of service
                                </a>
                                and acknowledge the
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="promotional_emails"
                                id="promotionalEmails" value="1" {{ old('promotional_emails') ? 'checked' : '' }}>
                ...
                <div class="accor-btn mt-4">
                    <button type="submit" class="blue-btn cta cta_white register_details_btn w-100 py-3 "
                        style="text-transform:unset !important; background-color: #06498b; color: white; border-radius: 30px; font-size: 15px; transition: background 0.2s;">Sign
                        up</button>
                </div>
            </form>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const emailInput = loginModal.querySelector('input[name="email"]') || loginModal.querySelector(
            '#emailAddress');
        const passwordInput = loginModal.querySelector('input[name="password"]') || loginModal.querySelector(
            '#password');
    ...
    $(document).ready(function() {
        function checkScroll() {
            ...
            @if(Route::currentRouteName() === 'top-rated-product' || Route::currentRouteName() ===
                'category.detail')
            $myElement.show();
            return;
            @endif
    ...
    <div class="category-sidebar" id="categories-sidebar">
        <div class="category-sidebar-header">
            ...
            <a href="{{ route('user-profile', ['locale' => app()->getLocale()]) }}" class="user-greeting">
                ...
                <img src="{{ asset(Auth::user()->profile_image) }}" alt="Profile" class="profile-circle"
                ...
                <div class="category-sidebar-panel active" id="main-panel">
                    ...
                    <div class="sidebar-menu-section">
                        ...
                        <ul class="sidebar-menu-list">
                            ...
                            @if($cat->translation)
                            <li>
                                <a href="javascript:void(0);" class="parent-category-item"
                ...
                <div class="category-sidebar-panel sub-panel" id="sub-panel-{{ $cat->id }}">
                    ...
                    <div class="sidebar-menu-section">
                        ...
                        <ul class="sidebar-menu-list">
                            ...
                            <li>
                                <a
                                    href="{{ route('category.detail', ['locale' => app()->getLocale(), 'slug' => $subCat->translation->slug]) }}">
                                    {{ $subCat->translation->name }}
                                </a>
                            </li>
                            @endif
    ...
    .category-sidebar-panels-container {
        display: flex;
        width: 300%;
        /* We have Main Panel + Sub Panel + Business Panel side-by-side */
        height: 100%;
