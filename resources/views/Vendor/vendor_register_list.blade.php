    ...
    <section class="contact_sec login_form p_120 pt-0 light">
        <div class="container">
            <div class="contact_content" data-aos="fade-up" data-aos-duration="1000">
                ...
                <form class="register_form" action="{{ route('vendor-register.store', ['locale'=> getCurrentLocale()]) }}" method="post" id="registerForm">
                    @csrf
                    <div class="row">
                    ...
                    use App\Models\Business;
                        ...
                        $businesses = Business::with('translations')->get(); // id => name format
                        $options = $businesses->mapWithKeys(function($business) {
                            return [$business->id => $business->translations->first()?->name ?? ''];
                        });
                         //dd($options);
                    ...
                    {{-- <div class="col-lg-6"> --}}
                        <div class="row">
                        <div class="form-group form-group_m">
                        <x-google-input type="select" name="business_id" id="business_id" label="Business" :options="$options" :alwaysActive="true" />
        ...
        $(document).ready(function () {
            ...
            $('.register_btn').click(function (e) {
                ...
                form.find('input, select').each(function () {
                    ...
                    // Dropdown validation (Business, Country, etc.)
            ...
            // Remove errors on typing/selecting
